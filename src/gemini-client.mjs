  ...
  const sizeGuideValidationRules =
    isSizeGuideSlot(slot)
      ? [
          ...
          `- fail unless the height label is present, legible Hebrew, horizontal, not rotated, not split, and exactly "גובה ${heightCm} ס״מ"`,
          `- fail unless the width label is present, legible Hebrew, horizontal, not rotated, not split, and exactly "רוחב ${widthCm} ס״מ"`,
